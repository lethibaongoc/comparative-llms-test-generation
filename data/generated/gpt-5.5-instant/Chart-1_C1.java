@Test
public void testGetLegendItems_nullPlotReturnsEmptyCollection() {
...
@Test
public void testGetLegendItems_nullDatasetReturnsEmptyCollection() {
    AbstractCategoryItemRenderer renderer =
        mock(AbstractCategoryItemRenderer.class, CALLS_REAL_METHODS);
...
@Test
public void testGetLegendItems_noRowsReturnsEmptyCollection() {
    AbstractCategoryItemRenderer renderer =
        mock(AbstractCategoryItemRenderer.class, CALLS_REAL_METHODS);
    CategoryPlot plot = mock(CategoryPlot.class);
    CategoryDataset dataset = mock(CategoryDataset.class);
